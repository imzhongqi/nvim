...

  {
    ...
    keys = function()
      return {
        ...
        { "<leader>bsh", require("smart-splits").swap_buf_left, desc = "Swap buffer to left", mode = { "n" } },
        { "<leader>bsj", require("smart-splits").swap_buf_down, desc = "Swap buffer to down", mode = { "n" } },
        { "<leader>bsk", require("smart-splits").swap_buf_up, desc = "Swap buffer to up", mode = { "n" } },
        { "<leader>bsl", require("smart-splits").swap_buf_right, desc = "Swap buffer to right", mode = { "n" } },
      }
    end,
    opts = function()
      return {
